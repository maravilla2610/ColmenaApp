...
class CartRecord extends FirestoreRecord {
  ...
  // "selectedItemsLst" field.
  List<DocumentReference>? _selectedItemsLst;
  List<DocumentReference> get selectedItemsLst => _selectedItemsLst ?? const [];
  bool hasSelectedItemsLst() => _selectedItemsLst != null;
  ...
  void _initializeFields() {
    ...
    _selectedItemsLst = getDataList(snapshotData['selectedItemsLst']);
  }
...
class CartRecordDocumentEquality implements Equality<CartRecord> {
  ...
  bool equals(CartRecord? e1, CartRecord? e2) {
    ...
    return e1?.creator == e2?.creator &&
        ...
        e1?.amount == e2?.amount &&
        listEquality.equals(e1?.selectedItemsLst, e2?.selectedItemsLst);
  }

  @override
  int hash(CartRecord? e) => const ListEquality().hash(
      [e?.creator, e?.itemCount, e?.isActive, e?.amount, e?.selectedItemsLst]);
