...
class OrderRecord extends FirestoreRecord {
  ...
  List<DocumentReference> get itemsList => _itemsList ?? const [];
  bool hasItemsList() => _itemsList != null;
  ...
  void _initializeFields() {
    ...
    _itemsList = getDataList(snapshotData['itemsList']);
  }
...
class OrderRecordDocumentEquality implements Equality<OrderRecord> {
  ...
  bool equals(OrderRecord? e1, OrderRecord? e2) {
    ...
    return e1?.name == e2?.name &&
        ...
        e1?.cart == e2?.cart &&
        listEquality.equals(e1?.itemsList, e2?.itemsList);
  }
