...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryText = const Color(0xCC211C1C);
  late Color secondaryText = const Color(0xFFA2A9B2);
  late Color primaryBackground = const Color(0xFFF8F3EE);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFFA2A9B2);
