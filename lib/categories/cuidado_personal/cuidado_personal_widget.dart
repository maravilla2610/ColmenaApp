...
import 'cuidado_personal_model.dart';
export 'cuidado_personal_model.dart';

class CuidadoPersonalWidget extends StatefulWidget {
  const CuidadoPersonalWidget({
    Key? key,
  ...
  @override
  _CuidadoPersonalWidgetState createState() => _CuidadoPersonalWidgetState();
}

class _CuidadoPersonalWidgetState extends State<CuidadoPersonalWidget>
    with TickerProviderStateMixin {
  late CuidadoPersonalModel _model;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProductosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductosRecord> cuidadoPersonalProductosRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final cuidadoPersonalProductosRecord =
            cuidadoPersonalProductosRecordList.isNotEmpty
                ? cuidadoPersonalProductosRecordList.first
                : null;
        return Title(
            title: 'CuidadoPersonal',
              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  leading: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('CUIDADO_PERSONAL_Icon_nhyx62wv_ON_TAP');
                      ...
                      child: StreamBuilder<List<CartRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CUIDADO_PERSONAL_shoppingCart_ICN_ON_TAP');
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  'Todas tus bebidas en un solo lugar',
                                  style:
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CUIDADO_PERSONAL_Container_4na9qigz_ON_T');
                                              logFirebaseEvent(
