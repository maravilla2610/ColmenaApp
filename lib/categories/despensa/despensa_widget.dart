...
import 'despensa_model.dart';
export 'despensa_model.dart';

class DespensaWidget extends StatefulWidget {
  const DespensaWidget({
    Key? key,
  ...
  @override
  _DespensaWidgetState createState() => _DespensaWidgetState();
}

class _DespensaWidgetState extends State<DespensaWidget>
    with TickerProviderStateMixin {
  late DespensaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DespensaModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Despensa'});
    setupAnimations(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProductosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductosRecord> despensaProductosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final despensaProductosRecord = despensaProductosRecordList.isNotEmpty
            ? despensaProductosRecordList.first
            : null;
        return Title(
            title: 'Despensa',
              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  leading: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('DESPENSA_PAGE_Icon_6y29gn1d_ON_TAP');
                      ...
                      child: StreamBuilder<List<CartRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'DESPENSA_PAGE_shoppingCart_ICN_ON_TAP');
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      ...
                                      return Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'DESPENSA_PAGE_Container_2f2hp359_ON_TAP');
                                            logFirebaseEvent(
